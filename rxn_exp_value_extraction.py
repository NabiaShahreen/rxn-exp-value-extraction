...
input_workbook1 = xlrd.open_workbook('gene_expression_iSA863.xls')

#loading data into pandas dataframe for fetching corresponding gene expression value
df = pandas.read_excel('gene_expression_iSA863.xls', sheet_name=0)
...
exp_value_column = 'Expression Values'
